...
public class mainForm {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    try{
                        ...
                        sql = "SELECT * FROM signs WHERE description like '%curve%'";
                        ...
                        sql="SELECT reservations.ID, customers.name AS custname, signs.description AS descr, " +
                            ...
                            "WHERE requestedOn BETWEEN '2019-01-01' AND '2020-10-30'";
    ...
    private Connection openDatabase( ) {
        try {
            ...
            String myUrl = "jdbc:mysql://cleanearthsoftware.com/4236paulgarlandclean_cims";
            Class.forName(myDriver);
            Connection conn = DriverManager.getConnection(myUrl, "cims_user", "CSC4610-01");
            return conn;
        }
        catch (Exception ex) {
